...
def get_options():
    ...
    parser.add_argument('-p',choices=['bac','fun','vir','par','data_stat','sample_info'], type=str, required=True, help="Choose one")
...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="../../templates/admin/df_style.css">
    <body>
        {table}
    </body>
</html>
